  ...
  en: {
    translation: {
      ...
      properties: {
        ...
        noParent: "None",
        ioOf: "IO of",
        ioComponent: "IO component",
        ioPin: "IO pin",
        noIoComponent: "Select component",
        noIoPin: "Select pin",
        ioLinkOffsetX: "IO address X",
        ioLinkOffsetY: "IO address Y",
        ioLinkRotation: "IO address rotation",
        ioLinkFontSize: "IO address size",
        ioLinkAlign: "IO address align",
        showIoPinTag: "Show IO pin name",
        ioPinTagOffsetX: "IO pin name X",
        ioPinTagOffsetY: "IO pin name Y",
        ioPinTagRotation: "IO pin name rotation",
        ioPinTagFontSize: "IO pin name size",
        ioPinTagAlign: "IO pin name align",
        ioPinLinkOffsetX: "Pin address X",
        ioPinLinkOffsetY: "Pin address Y",
        ioPinLinkRotation: "Pin address rotation",
        ioPinLinkFontSize: "Pin address size",
        ioPinLinkAlign: "Pin address align",
  ...
  "pt-BR": {
    translation: {
      ...
      properties: {
        ...
        noParent: "Nenhum",
        ioOf: "IO de",
        ioComponent: "Componente do IO",
        ioPin: "Pino do IO",
        noIoComponent: "Selecione o componente",
        noIoPin: "Selecione o pino",
        ioLinkOffsetX: "Endereco no IO X",
        ioLinkOffsetY: "Endereco no IO Y",
        ioLinkRotation: "Rotacao do endereco no IO",
        ioLinkFontSize: "Tamanho do endereco no IO",
        ioLinkAlign: "Alinhamento do endereco no IO",
        showIoPinTag: "Mostrar nome do pino no IO",
        ioPinTagOffsetX: "Nome do pino no IO X",
        ioPinTagOffsetY: "Nome do pino no IO Y",
        ioPinTagRotation: "Rotacao do nome do pino no IO",
        ioPinTagFontSize: "Tamanho do nome do pino no IO",
        ioPinTagAlign: "Alinhamento do nome do pino no IO",
        ioPinLinkOffsetX: "Endereco no pino X",
        ioPinLinkOffsetY: "Endereco no pino Y",
        ioPinLinkRotation: "Rotacao do endereco no pino",
        ioPinLinkFontSize: "Tamanho do endereco no pino",
        ioPinLinkAlign: "Alinhamento do endereco no pino",
